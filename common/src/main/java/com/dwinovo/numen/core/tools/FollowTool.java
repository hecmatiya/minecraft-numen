...
import com.dwinovo.numen.core.task.FollowTaskRecord;
 ...
 * 两者<b>目标消失时的含义不同</b>,见 {@link FollowTaskRecord#entityId}。
 *
 * <p>移植自 1.21.1(26.1.2 重构时被落下),派发改用 {@link #dispatchAsync}。
 */
public final class FollowTool implements NumenTool {
    ...
    public void onServerCall(String toolCallId, JsonObject args, NumenPlayer companion,
        ...
        dispatchAsync(companion,
                new FollowTaskRecord(toolCallId, distance, entityId, targetUuid), reply);
    }
}
